...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<%--<td class="ct_write01"><%=purchaseVO.getPurchaseProd().getProdName() %></a></td>--%>
		<td class="ct_write01">${ purchase.purchaseProd.prodName }</a></td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
	...
	<tr>
		...
		<td class="ct_write01">
			<%--<input 	type="text" name="receiverPhone" class="ct_input_g" 
							style="width: 100px; height: 19px" maxLength="20" value="<%=purchaseVO.getBuyer().getPhone() %>" />--%>
			<input 	type="text" name="receiverPhone" class="ct_input_g" 
	...
	<tr>
		...
		<%--	<input 	type="text" name="receiverAddr" class="ct_input_g" 
							style="width: 100px; height: 19px" maxLength="20" 	value="<%=purchaseVO.getBuyer().getAddr() %>" />--%>
			<input 	type="text" name="divyAddr" class="ct_input_g" 
							style="width: 100px; height: 19px" maxLengt="20" value="${ purchase.divyAddr }" />
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>

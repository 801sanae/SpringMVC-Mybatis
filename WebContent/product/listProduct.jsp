...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	...
	<c:forEach var="product" items="${list}">
		...
		<tr class="ct_list_pop">
			...
			<td></td>
			<td align="left">
			<a href="/getProduct.do?prodNo=${product.prodNo }&menu=manage">${product.prodName }</a></td>		
			<td></td>
		...
		<c:if test="${  fn:trim(product.proTranCode) =='1' }">
			구매완료<a href="/updateTranCodeByProd.do?prodNo=${ product.prodNo }&menu=manage&tran_status_code=${product.proTranCode}">배송하기</a>
		</c:if>
